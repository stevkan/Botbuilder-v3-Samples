...
controller.api.messenger_profile.menu([{
    "locale": "default",
    "composer_input_disabled": false, // originally true
    "call_to_actions": [
        {
            "title": "My Skills",
            "type": "nested",
                    ...
                    'elements': [
                        {
                            ...
                            'image_url': 'https://images.cheapestees.com/colorblock/enlarge/3931-white.jpg',
                            'subtitle': 'Soft white cotton t-shirt is back in style',
                            'buttons': [
                                {
                                    'type': 'web_url',
                                    'url': 'http://www.cheapestees.com/fruit-of-the-loom-3931-tshirt.html',
                                    'title': 'View Item'
                                },
                                {
                                    'type': 'web_url',
...
controller.hears(['demo template'], 'message_received', function (bot, message) {
    bot.startConversation(message, function (err, convo) {
        convo.ask({
            attachment: {
                'type': "template",
